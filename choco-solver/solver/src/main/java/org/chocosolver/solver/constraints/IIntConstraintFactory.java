...
import org.chocosolver.solver.constraints.camel.CamelEqual;
...
import org.chocosolver.solver.constraints.mincumulative.MinCumulative;
...
public interface IIntConstraintFactory extends ISelf<Model> {
    ...
    default Constraint camelEqual(IntVar x, IntVar y) {
        return new CamelEqual(x, y);
    }

    default Constraint minCumulative(IntVar[] starts, IntVar[] processingTimes, IntVar[] heights, int[] demand) {
        return new MinCumulative(starts, processingTimes, heights, demand);
    }
